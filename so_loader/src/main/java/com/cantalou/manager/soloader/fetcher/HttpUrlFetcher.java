...
public class HttpUrlFetcher implements Fetcher
{
    ...
    public HttpUrlFetcher(String url, Map<String, String> headers)
    {
        this(url, headers, DEFAULT_CONNECTION_FACTORY);
    }

    public HttpUrlFetcher(String url, Map<String, String> headers, HttpUrlConnectionFactory connectionFactory)
    {
        this.url = url;
    ...
    public InputStream loadData() throws Exception
    {
        ...
        while (i < MAX_RETRY)
        {
            try
            {
                return loadDataWithRedirects(new URL(url), 0, null, headers);
            }
    ...
    private InputStream loadDataWithRedirects(URL url, int redirects, URL lastUrl, Map<String, String> headers) throws IOException
    {
        ...
        return loadData(url, redirects, headers);
    }

    public InputStream loadData(URL url, int redirects, Map<String, String> headers) throws IOException
    {
     ...
     */
    private static class ContentLengthInputStream extends FilterInputStream
    {
        ...
        private int checkReadSoFarOrThrow(int read) throws IOException
        {
            ...
            {
                throw new IOException("Failed to read all expected data" + ", expected: " + contentLength + ", but read: " + readSoFar);
            }
            return read;
        }
    }
